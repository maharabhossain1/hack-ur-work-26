...
export function ImageStack({
  ...
  // Keyboard nav inside modal — stop propagation so slide nav doesn't fire
  ...
  return (
    <>
      {/* Thumbnail row */}
      {compact ? (
        /* Compact strip — tiny thumbnails, minimal height */
      ...
      {modalIdx !== null && (
        <div
          className="fixed inset-0 bg-black/85 z-[200] flex flex-col items-center justify-center"
          onClick={() => setModalIdx(null)}
        >
          {/* Modal card */}
          <div
            className="bg-[#1a1a1a] rounded-2xl overflow-hidden shadow-2xl w-[90vw] max-w-4xl flex flex-col outline-none"
